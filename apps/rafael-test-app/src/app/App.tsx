        ...
        <View style={styles.section}>
          <View style={styles.shadowBox}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                Linking.openURL('https://cloud.nx.app/connect/cjlsTrVkWf');
              }}
            >
              <Text
                style={[
          ...
          <View style={styles.shadowBox}>
            ...
            <View style={styles.codeBlock}>
              ...
              <Text
                style={[styles.textXS, styles.monospace, styles.marginBottomMd]}
              >
                nx test RafaelTestApp
              </Text>
              <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                # Lint
              </Text>
              <Text style={[styles.textXS, styles.monospace]}>
                nx lint RafaelTestApp
              </Text>
              <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                # Run them together!
              </Text>
              <Text
                style={[styles.textXS, styles.monospace, styles.marginBottomMd]}
              >
                nx run-many -p RafaelTestApp -t build test lint
              </Text>
            </View>
